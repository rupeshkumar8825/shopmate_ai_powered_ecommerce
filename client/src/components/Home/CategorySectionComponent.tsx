...
export const CategorySectionComponent = () => {
    return (
        <div className="border-2 border-white flex flex-col justify-center items-center bg-background-500 p-20 gap-5">
            ...
            <div className="border border-black flex gap-10 flex-wrap justify-center items-center w-full">
                {/*  another useful color is bg-indigo-950 */}
                {
                    listOfSupportedCategoriesData.map((currCategory : CategoryDataType, index : number) => {
                        return (
                            <div key={index} className="bg-component-background-500 flex flex-col gap-3 justify-center items-center border  p-5 rounded-2xl shadow shadow-white">
