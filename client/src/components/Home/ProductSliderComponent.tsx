                ...
                >
                    {
                        props.listOfProducts.map((currProduct : ProductDetail, index : number) => {
                            return (
                                // ✅ Card is now a plain div, not wrapped in Link
                                <div key={currProduct.id} className="bg-component-background-500 shrink-0 flex flex-col gap-3 justify-center items-center border p-5 rounded-2xl shadow-white w-64">
